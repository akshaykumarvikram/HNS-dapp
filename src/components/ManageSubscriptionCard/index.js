...
export default function ManageSubscriptonCard({
  channel,
  userSubs,
  userSubData,
}) {
  ...
  const subscribed = userSubs
    ? userSubs.indexOf(channel.channelId) > -1
    : false;
    ...
    <Card>
      ...
      >
        ...
        <Box flex={2}>
          ...
          >
            {subscribed ? "Edit Subscription" : "Subscribe"}
          </Button>
        </Box>
      </Box>
      <Divider />
      ...
      <SubscribeDialog
        ...
        channel={channel}
        previousState={subscribed ? userSubData[channel.channelId] : null}
